...
<head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css"
      ...
      crossorigin="anonymous">
        ...
        <!-- la nav che sto crendo serve per fare una barra in altro -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
    <div><img src="LogoGigi.jpg" alt="logo gigi"></div>
      <div onclick ='homePage()'class="container"> <a class="navbar-brand" href="#">ScommettereComeGigi</a>
      </div>
 ...
 <div class="container">
  <div class="row">
    <div class="col"> <div class="col-lg-7">
  			...
  			<h1>Stake Medio</h1>
  			<p>Ciao , qui trovi tutte le mie giocato con difficolta' media ...
    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        <div class="card h-100" >
          ...
          <div class="card-footer"> <a href='/Prova/Servlet?action=medio' class="btn btn-warning">Approfondisci</a>
          </div>
        </div>
      </div>
      <div class="col-md-4 mb-4">
        ...
        <div class="card-footer"> <a href='/Prova/Servlet?action=basso' class="btn btn-warning">Approfondisci</a> 
